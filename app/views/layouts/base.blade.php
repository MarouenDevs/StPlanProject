    ...
    <body>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown profile">
                        <a href="javascript:void(0);" class="dropdown-toggle dropdown-hover" data-toggle="dropdown">
                            <span class="meta">
                                <span class="text hidden-xs hidden-sm pl5">{{Auth::user()->login}}</span>
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="divider"></li>
                            <li><a href="javascript:void(0);"><span class="icon"><i class="ico-user-plus2"></i></span> Mon compte</a></li>
                            <li><a href="javascript:void(0);"><span class="icon"><i class="ico-cog4"></i></span>Paramétres</a></li>
                            <li class="divider"></li>

                            <li><a  id="logout"><span class="icon"><i class="ico-exit"></i></span> Deconnexion</a></li>
        ...
        <aside class="sidebar sidebar-left sidebar-menu">
            ...
            <section class="content slimscroll">
                <h5 class="heading">Menu principale</h5>
            ...
            <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    <div class="page-header-section">
                        <h4 class="title semibold">@yield('pageTitle')</h4>
                    </div>
